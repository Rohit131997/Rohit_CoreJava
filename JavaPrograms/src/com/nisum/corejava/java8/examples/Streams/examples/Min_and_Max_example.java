...
public class Min_and_Max_example {
    public static void main(String[] args) {
        ...
        int minimum_ascending = numbers.stream().min( (value1, value2) -> value1.compareTo( value2 ) ).get();
        MyLogger.consoleLogger.info( "Minimum value in ascending order: " + minimum_ascending );

        int maximum_ascending = numbers.stream().max( (value1, value2) -> value1.compareTo( value2 ) ).get();
        ...
        int minimum_desending = numbers.stream().min( (value1, value2) -> value2.compareTo( value1 ) ).get();
        MyLogger.consoleLogger.info( "Minimum value in Desending order: " + minimum_desending );

        int maximum_desending = numbers.stream().max( (value1, value2) -> value2.compareTo( value1 ) ).get();
